...
import { Breadcrumb, BreadcrumbItem, Button, Form, FormGroup, Label, Input, Call, Col, Row, FormFeedback } from 'reactstrap';
...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if (this.state.touched.telnum && !reg.test(telnum)) {
            ...
            errors.telnum = 'Tel Num should be of 10 numbers';
        }
